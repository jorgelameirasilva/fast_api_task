...
def num_tokens_from_messages(messages: dict[str, str], model: str) -> int:
    """
    Calculate the number of tokens required to encode a message.
    Args:
        messages (dict): The message to encode, represented as a dictionary.
    ...
    num_tokens = 0  # For "role" and "content" keys
